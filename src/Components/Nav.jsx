...
export default function Nav() {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 mx-auto max-w-md h-[70px] flex items-center bg-[var(--black)] text-[var(--dark-gray)] z-10 border-t-[1px] border-[var(--dark-gray)]">
